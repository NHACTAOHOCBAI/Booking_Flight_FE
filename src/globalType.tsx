...
export const airportData: IAirportTable[] = [
  { id: '1', airportCode: 'SGN', airportName: 'Tan Son Nhat International Airport', cityCode: '1' },
  { id: '2', airportCode: 'HAN', airportName: 'Noi Bai International Airport', cityCode: '2' },
  { id: '3', airportCode: 'DAD', airportName: 'Da Nang International Airport', cityCode: '3' },
  { id: '4', airportCode: 'CXR', airportName: 'Cam Ranh International Airport', cityCode: '4' },
  { id: '5', airportCode: 'VCS', airportName: 'Con Dao Airport', cityCode: '5' },
  { id: '6', airportCode: 'PQC', airportName: 'Phu Quoc International Airport', cityCode: '6' },
  { id: '7', airportCode: 'VII', airportName: 'Vinh International Airport', cityCode: '7' },
  { id: '8', airportCode: 'HUI', airportName: 'Phu Bai International Airport', cityCode: '8' },
  { id: '9', airportCode: 'BMV', airportName: 'Buon Ma Thuot Airport', cityCode: '9' },
  { id: '10', airportCode: 'VCA', airportName: 'Can Tho International Airport', cityCode: '10' }
]
export const flightData: IFlightTable[] = [
    ...
    seat: [
      {
        seatName: '1',
        quantity: 50,
        price: 200 // Giá cho hạng 1
      },
      {
        seatName: '2',
        quantity: 30,
        price: 150 // Giá cho hạng 2
      },
      {
        seatName: '3',
        quantity: 20,
        price: 100 // Giá cho hạng 3
      }
    ],
    departureAirportName: 'a',
    arrivalAirportName: 'a'
  },
  {
    id: '2',
    flightCode: 'FL002',
  ...
  },
  {
    ...
    seat: [
      ...
      { seatName: '3', quantity: 10, price: 110 }
    ],
    departureAirportName: 'a',
    arrivalAirportName: 'a'
  },
  {
    ...
    seat: [
      ...
      { seatName: '3', quantity: 25, price: 700000 }
    ],
    departureAirportName: 'a',
    arrivalAirportName: 'a'
  },
  {
    ...
    seat: [
      ...
      { seatName: '3', quantity: 30, price: 110 }
    ],
    departureAirportName: 'a',
    arrivalAirportName: 'a'
  },
  {
    ...
    seat: [
      ...
      { seatName: '3', quantity: 15, price: 120 }
    ],
    departureAirportName: 'a',
    arrivalAirportName: 'a'
  },
  {
    ...
    seat: [
      ...
      { seatName: '3', quantity: 10, price: 130 }
    ],
    departureAirportName: 'a',
    arrivalAirportName: 'a'
  },
  {
    ...
    seat: [
      ...
      { seatName: '3', quantity: 20, price: 150 }
    ],
    departureAirportName: 'a',
    arrivalAirportName: 'a'
  },
  {
    ...
    seat: [
      ...
      { seatName: '3', quantity: 30, price: 140 }
    ],
    departureAirportName: 'a',
    arrivalAirportName: 'a'
  },
  {
    ...
    seat: [
      ...
      { seatName: '3', quantity: 20, price: 160 }
    ],
    departureAirportName: 'a',
    arrivalAirportName: 'a'
  }
