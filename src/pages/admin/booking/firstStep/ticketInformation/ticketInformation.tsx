              ...
              >
                <div style={{ fontWeight: 'bold', fontSize: 18, textAlign: 'left', marginBottom: 10 }}>
                  <BsFillTicketPerforatedFill
                    style={{ width: 25, height: 25, verticalAlign: 'middle', marginRight: 5, marginBottom: 3 }}
                  />
                  {`Ticket ${field.name + 1}`}
                </div>
                <Form.Item
                  label={
                    <div>
                      <PiSeatBold style={{ width: 20, height: 20, verticalAlign: 'middle' }} /> Seat class
                    </div>
                  }
                ...
                <Form.Item
                  label={
                    <div>
                      <FiPhone style={{ width: 20, height: 20, verticalAlign: 'middle' }} /> Phone
                    </div>
                  }
                ...
                <Form.Item
                  label={
                    <div>
                      <MdOutlineMail style={{ width: 20, height: 20, verticalAlign: 'middle' }} /> Email
                    </div>
                  }
                ...
                <Form.Item
                  label={
                    <div>
                      <HiOutlineIdentification style={{ width: 20, height: 20, verticalAlign: 'middle' }} /> Identify
                      card
                    </div>
                  }
